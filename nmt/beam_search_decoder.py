...
# ==============================================================================
"""
A Patched beam_search_decoder.py to handle the issue with gradient computing
...
def _beam_search_step(time, logits, next_cell_state, beam_state, batch_size,
  ...
  next_beam_probs = _tensor_gather_helper(
      ...
      gather_shape=[-1])
  ### pathced part starts
  next_word_ids = gen_array_ops.stop_gradient(
      math_ops.to_int32(word_indices % vocab_size))
  next_beam_ids = gen_array_ops.stop_gradient(
      math_ops.to_int32(word_indices / vocab_size))
  ### patched part ends
